...
namespace Marvin.IDP.Pages.User.Registration
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            _localUserService = localUserService ?? throw new Exception(nameof(ILocalUserService));
            _interaction = interaction ?? throw new Exception(nameof(IIdentityServerInteractionService));
        }
